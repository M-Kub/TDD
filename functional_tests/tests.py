...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        if staging_server:
            self.live_server_url = 'http://mikub.online' + staging_server
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ##Using new browser session to make sure that no information,
    ...
    def test_layout_and_styling(self):
        ...
        # Satisfied, they both go back to sleep back to sleep
